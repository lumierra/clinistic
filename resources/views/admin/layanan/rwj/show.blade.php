...
<x-layouts>
                                ...
                                @if (Auth::user()->role_id == 5)
                                    ...
                                    <div class="tab-content tabcontent-border">
                                        <div class="tab-pane active" id="catatanRwj" role="tabpanel">
                                            @include('admin.layanan.rwj.catatan')
                                        </div>
    ...
    @push('script')
        ...
        <script>
            ...
            $('#btn-selesai-order').click(() => {
                let kunjungan = $('#kunjunganID').val()
                $.ajax({
                    data: {
                        kunjungan: kunjungan,
                    },
                    url: "{{ route('admin.ubah-farmasi.create') }}",
                    type: "GET",
                    dataType: 'json',
                    success: function (data) {
                        if (data.status == 200){
                            alertBerhasil('Order berhasil dikirim')
                            $('.tblFarmasi').DataTable().ajax.reload();
                        } else {
                            alertGagal(data.message);
                        }
            ...
            $('#btnSimpanRacikan').click(() => {
                ...
                if (nama_racikan == ''){
                    ...
                    $.ajax({
                        ...
                        dataType: 'json',
                        success: function (data) {
                            alertBerhasil('Obat Berhasil Disimpan')
                            tableRacikan()
                            $('#obat_farmasi_racikan').val('').trigger('change')
                            $('#jumlah_obat_racikan').val('')
                        },
                        error: function (data) {
                            alertGagal('Obat Gagal Disimpan')
                        }
                    });
                }
            })
