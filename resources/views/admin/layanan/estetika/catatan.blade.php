                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="photo" name="photo" accept="image/png, image/gif, image/jpeg, image/jpg">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title text-success">Hasil Foto Upload <i class="fas fa-images"></i></h4>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select onchange="saveLab()" class="form-control" id="produk_lab" name="produk_lab" style="width: 100%;" required>
                                    <option selected disabled value="">--Pilih--</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select onchange="saveIcd()" class="form-control" id="penyakit_icd" name="penyakit_icd" style="width: 100%;" required>
                                    <option selected disabled value="">--Pilih--</option>
                                </select>
                            </div>
                        </div>
