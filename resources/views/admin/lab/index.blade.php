@section('title', 'Pelayanan Laboratorium')
        ...
        <div class="container-full">
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        <h3 class="page-title">Pelayanan Laboratorium <i class="fas fa-flask-vial fa-flip fs-30" style="--fa-animation-duration: 3s;" ></i></h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="box">
                            <div class="box-header with-border">
                              <h4 class="box-title">Pencarian Laboratorium</h4>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="box box-solid bg-primary bb-3 border-primary">
                            <div class="box-header with-border bg-primary">
                                <h3 class="box-title">Data Order Laboratorium</h3>
                            </div>
                            <div class="box-body">
        ...
        <script>
            ...
            $(function () {
                ...
                $('.dataServer').DataTable({
                    ...
                    language: {
                        "decimal": "",
                        "emptyTable": "Tidak ada data order laboratorium",
            ...
            function myStatus(status){
                ...
                $('.dataServer').DataTable({
                    ...
                    'serverSide': true,
                    'responsive': true,
                    'ajax': "{{ route('admin.ubah-lab.index') }}" + '/' + status + '/edit',
                    'columns': [
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', className:'text-center'},
                        {data: 'kd_lab', name: 'kd_lab', className: 'text-center'},
                        {data: 'tgl_order', name: 'tgl_order', className: 'text-center'},
            ...
            btnCari = status => {
                ...
                $('.dataServer').DataTable({
                    'processing': true,
                    'serverSide': true,
                    'ajax': "{{ route('admin.ubah-lab.index') }}" + '/' + tanggal + '/edit',
                    'columns': [
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', className:'text-center'},
                        {data: 'kd_lab', name: 'kd_lab', className: 'text-center'},
                        {data: 'tgl_order', name: 'tgl_order', className: 'text-center'},
                    ...
                    language: {
                        "decimal": "",
                        "emptyTable": "Tidak ada data order lab",
                        "info": "Menampilkan _START_ sampai _END_ dari _TOTAL_ data",
                        "infoEmpty": "Menampilkan 0 sampai 0 dari 0 data",
                        "infoFiltered": "(disaring dari _MAX_ total data)",
                        "infoPostFix": "",
