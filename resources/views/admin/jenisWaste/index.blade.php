                    ...
                    <div class="col-12">
                        <div class="box">
                            <div class="box-header with-border bg-primary">
                                <h3 class="box-title">Data Jenis Waste</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label class="form-label">Nama Kategori Waste</label><br>
        ...
        <script>
            $(function () {
                ...
                $('.dataServer').DataTable({
                    'processing': true,
                    'serverSide': true,
                    'ajax': "{{ route('admin.jenis-waste.index') }}",
                    'columns': [
            ...
            $('#add').click(function () {
                ...
                $('#headerModal').html("Tambah Jenis Waste");
            ...
            $('body').on('click', '.editProduct', function () {
                ...
                $('#modalForm').modal('show');
                $.ajax({
                    url: "{{ route('admin.jenis-waste.index') }}" + '/' + product_id + '/edit',
                    type: "GET",
                    dataType: 'json',
            ...
            $('#saveBtn').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.jenis-waste.store') }}",
                    type: "POST",
                    dataType: 'json',
                    success: function (data) {
                        alertSucces()
            ...
            $('body').on('click', '.deleteProduct', function () {
                ...
                swal({
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "{{ route('admin.jenis-waste.store') }}" + '/' + id,
                        success: function (data) {
                            $('.dataServer').DataTable().ajax.reload();
                        },
                        error: function (data) {
