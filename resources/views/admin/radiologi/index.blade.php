@section('title', 'Pelayanan Radiologi')
        ...
        <div class="container-full">
            <div class="content-header">
                <div class="d-flex align-items-center">
                    <div class="me-auto">
                        <h3 class="page-title">Pelayanan Radiologi <i class="fas fa-x-ray fa-flip fs-30" style="--fa-animation-duration: 3s;" ></i></h3>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="box">
                            <div class="box-header with-border">
                              <h4 class="box-title">Pencarian Radiologi</h4>
                            </div>
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="box box-solid bg-primary bb-3 border-primary">
                            <div class="box-header with-border bg-primary">
                                <h3 class="box-title">Data Order Radiologi</h3>
                            </div>
                            <div class="box-body">
    ...
    <script src="{{ asset('template/assets/vendor_components/select2/dist/js/select2.full.js') }}"></script> --}}
        ...
        <script>
            ...
            $('.dataServer').DataTable({
                ...
                'serverSide': true,
                'responsive': true,
                'ajax': "{{ route('admin.radiologi.index') }}",
                'columns': [
            ...
            function myStatus(status){
                ...
                $('.dataServer').DataTable({
                    ...
                    'serverSide': true,
                    'responsive': true,
                    'ajax': "{{ route('admin.ubah-radiologi.index') }}" + '/' + status + '/edit',
                    'columns': [
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', className:'text-center'},
                        {data: 'kd_rad', name: 'kd_rad', className: 'text-center'},
                        {data: 'tgl_order', name: 'tgl_order', className: 'text-center'},
            ...
            btnCari = status => {
                ...
                $('.dataServer').DataTable({
                    'processing': true,
                    'serverSide': true,
                    'ajax': "{{ route('admin.ubah-radiologi.index') }}" + '/' + tanggal + '/edit',
                    'columns': [
                        {data: 'DT_RowIndex', name: 'DT_RowIndex', className:'text-center'},
                        {data: 'kd_rad', name: 'kd_rad', className: 'text-center'},
                        {data: 'tgl_order', name: 'tgl_order', className: 'text-center'},
