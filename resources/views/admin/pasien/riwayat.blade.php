            ...
            <table class="table table-striped table-bordered" id="tableRiwayat">
                <thead>
                    <tr>
                        ...
                        <th>Diagnosa</th>
                        <th class="text-center" width="200px">Status Pemeriksaan</th>
                    </tr>
                </thead>
                <tbody>
                    @forelse ($kunjungan as $item)
                        <tr data-bs-toggle="collapse" data-bs-target="#collapse{{ $item->id }}" class="accordion-toggle">
                            ...
                            <td class="text-center">
                                @if ($item->status_pasien == 'belum_selesai')
                                    <span class="badge badge-danger">Belum Dilayani</span>
                                @elseif ($item->status_pasien == 'diproses')
                                    <span class="badge badge-warning">Sedang Dilayani</span>
                                @else
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center">Tidak ada data riwayat kunjungan</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
